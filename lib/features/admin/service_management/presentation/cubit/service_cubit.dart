...
///
/// Uses the unified [AdminServiceRepository] for all operations,
/// eliminating the previous dual-injection anti-pattern.
@injectable
class ServiceCubit extends Cubit<ServiceState> {
  ServiceCubit(this._repository, this._logger) : super(const ServiceInitial());
  ...
  Future<void> createService(ServiceEntity service) async {
    ...
    final result = await _repository.createService(service);
    switch (result) {
      case Success():
